...
namespace API.Domain.DatabaseMapping
{
    public class ResourceMapping  : IEntityTypeConfiguration<Resource>
    {
        public void Configure(EntityTypeBuilder<Resource> builder)
        {
            ...
            builder.Property(a => a.CreatedAt).HasColumnName("RES_CREATED_AT").ValueGeneratedOnAdd().IsRequired();
            builder.Property(a => a.UpdatedAt).HasColumnName("RES_UPDATE_AT").IsRequired();
