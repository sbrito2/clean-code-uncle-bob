...
namespace AspNetCoreAngularSignalR.Controllers
{
    ...
    public class FoodItemsController : Controller
    {
        ...
        public FoodItemsController(IFoodRepository foodRepository, IHubContext<ChatHub> hubContext, IMapper mapper)
        {
        ...
        public ActionResult AddFoodToList([FromBody] FoodItemDto viewModel)
        {
            ...
            return CreatedAtRoute(nameof(GetSingleFood),new { id = newFoodItem.Id },_mapper.Map<FoodItemDto>(newFoodItem));
        }
