    ...
    public class UnitTest1
    {
        ...
        public void ShouldGetAllProducts()
        {
            ...
            if (products != null)
            {
                ...
                // Assert.True(comparer.CompareList(productsList, this.products) == 0); //(normal)
                // productsList.Should().BeEquivalentTo(this.products); (FluentAssertions)
                // productsList.ShouldBe(this.products); //it is not working
                productsList.ToExpectedObject().ShouldMatch(this.products.FirstOrDefault(x => x.Id == 2));
            }
        }
        ...
        public void ShouldAddProduct()
        {
            ...
            var helper = new ProductComparer();
            Assert.True(helper.Compare(newProduct, this.products.Last()) == 0); // normal
            // newProduct.Should().BeEquivalentTo(this.products.Last());
            // newProduct.ShouldBe(this.products.Last());
