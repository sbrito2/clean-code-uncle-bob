...
namespace console.Models
{
    public partial class contextEntities : DbContext
    {
        ...
        // public virtual int IncrementProcedure(int value)
        // {
        //     var data = DbContext.Database.SqlQuery<Object>("increment ", value);

        // }


        // public virtual ObjectResult<int> IncrementProcedure(int value)
        // {
        //     return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<int>("increment", value);
        // }
