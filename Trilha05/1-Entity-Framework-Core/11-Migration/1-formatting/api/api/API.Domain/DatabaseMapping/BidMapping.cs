...
namespace API.Domain.DatabaseMapping
{
    public class BidMapping  : IEntityTypeConfiguration<Bid>
    {
        public void Configure(EntityTypeBuilder<Bid> builder)
        {
            ...
            builder.Property(a => a.CreatedAt).HasColumnName("BID_CREATED_AT").ValueGeneratedOnAdd().IsRequired();
            builder.Property(a => a.UpdatedAt).HasColumnName("BID_UPDATE_AT").IsRequired();
