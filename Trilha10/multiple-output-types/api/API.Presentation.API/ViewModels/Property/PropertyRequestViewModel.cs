...
namespace API.Presentation.API.ViewModels.Property
{
    public class PropertyRequestViewModel 
    {
        ...
        [Required(ErrorMessage = "Campo valor de praça 1 é obrigatório", AllowEmptyStrings = false)]
        public decimal InitialBid1 { get; set; }
        [Required(ErrorMessage = "Campo valor de praça 2 é obrigatório", AllowEmptyStrings = false)]
