...
{
    public class RamdonPhotoUrlResolver<TEntity> : IMemberValueResolver<TEntity, Object, string, string> where TEntity : Entity
    {
        private readonly string DownloadUrl;
        private readonly string[] Extensions = {".png", ".jpeg"};

        public RamdonPhotoUrlResolver(IConfiguration config)
        {
