...
namespace chainOfResponsability
{
    ...
    {
        public StepRunner<Tin, Tout> AddStep<T, Tin, Tout>(T placeholder) where T : IStep<Tin, Tout>
        {
    ...
    {
        public static StepRunner<T1, TResult> AddStep<T, T1, T2, TResult>(this StepRunner<T1, T2> pipeline, T placeholder) where T : IStep<T2, TResult>
        {
